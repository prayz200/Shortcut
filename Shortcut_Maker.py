...
lb = Listbox(Top_Frame, width=69, height=70, bd=0, selectmode=SINGLE, justify=LEFT)
...
lbl = Label(Bottom_Frame, text=r"https://twitter.com/pryz208", height=0, fg='gray', cursor="hand2")
lbl.grid(row=5, column=0, columnspan=2)
Label(Bottom_Frame, text="Drücken sie auf \"Dateipfad hinzufügen\" \noder ziehen sie Datei eine über das übere Feld",
